...
public class GaugeMonitor extends Monitor implements GaugeMonitorMBean {
   ...
   /**
    ...
    private synchronized void setDerivedGaugeWithDifference(
        ...
        switch (o.getType()) {
        case INTEGER:
            der = Integer.valueOf(scanGauge.intValue() -
                                  prev.intValue());
            break;
        case BYTE:
            der = Byte.valueOf((byte)(scanGauge.byteValue() -
                                      prev.byteValue()));
            break;
        case SHORT:
            der = Short.valueOf((short)(scanGauge.shortValue() -
                                        prev.shortValue()));
            break;
        case LONG:
            der = Long.valueOf(scanGauge.longValue() -
                               prev.longValue());
            break;
        case FLOAT:
            der = Float.valueOf(scanGauge.floatValue() -
                                prev.floatValue());
            break;
        case DOUBLE:
            der = Double.valueOf(scanGauge.doubleValue() -
                                 prev.doubleValue());
            break;
        default:
            // Should never occur...
