...
public class RequiredModelMBean
                    ...
                    try {
                        writeToLog(logfile,"LogMsg: " +
                            ...
                            ntfyObj.getMessage() + " Severity = " +
                                ntfyDesc.getFieldValue("severity"));
                    } catch (Exception e) {
    ...
    private static final ModelMBeanNotificationInfo makeGenericInfo() {
        final Descriptor genericDescriptor = new DescriptorSupport("name=GENERIC",
    ...
    private static final
        ...
        final Descriptor attributeDescriptor = new DescriptorSupport("name=ATTRIBUTE_CHANGE",
                "descriptorType=notification",
                "log=T",
                "severity=6",
