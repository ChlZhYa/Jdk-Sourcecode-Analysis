    ...
    implements DirectBuffer
{
    ...
    public CharBuffer asCharBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 1) != 0)) {
            return (bigEndian
                    ? new ByteBufferAsCharBufferB(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? new DirectCharBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
                                                                 off)
                    : new DirectCharBufferS(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
    ...
    public ShortBuffer asShortBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 1) != 0)) {
            return (bigEndian
                    ? new ByteBufferAsShortBufferB(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
                                                                       off)
                    : new ByteBufferAsShortBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? new DirectShortBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
                                                                 off)
                    : new DirectShortBufferS(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
    ...
    public IntBuffer asIntBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 2) != 0)) {
            return (bigEndian
                    ? new ByteBufferAsIntBufferB(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
                                                                       off)
                    : new ByteBufferAsIntBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? new DirectIntBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
                                                                 off)
                    : new DirectIntBufferS(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
    ...
    public LongBuffer asLongBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 3) != 0)) {
            return (bigEndian
                    ? new ByteBufferAsLongBufferB(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
                                                                       off)
                    : new ByteBufferAsLongBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? new DirectLongBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
                                                                 off)
                    : new DirectLongBufferS(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
    ...
    public FloatBuffer asFloatBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 2) != 0)) {
            return (bigEndian
                    ? new ByteBufferAsFloatBufferB(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
                                                                       off)
                    : new ByteBufferAsFloatBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? new DirectFloatBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
                                                                 off)
                    : new DirectFloatBufferS(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
    ...
    public DoubleBuffer asDoubleBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 3) != 0)) {
            return (bigEndian
                    ? new ByteBufferAsDoubleBufferB(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
                                                                       off)
                    : new ByteBufferAsDoubleBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? new DirectDoubleBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
                                                                 off)
                    : new DirectDoubleBufferS(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
