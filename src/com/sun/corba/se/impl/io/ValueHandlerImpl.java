...
public final class ValueHandlerImpl implements javax.rmi.CORBA.ValueHandlerMultiFormat {
    ...
    public java.io.Serializable readValue(org.omg.CORBA.portable.InputStream _in,
        ...
        if (!useHashtables) {
            ...
            try {
                ...
                result = readValueInternal(inputStreamBridge, in, offset, clazz, repositoryID,
                        sender);
        ...
        try {
            ...
            result = readValueInternal(jdkToOrbInputStreamBridge, in, offset, clazz, repositoryID,
                    sender);
    ...
    private java.io.Serializable readValueInternal(IIOPInputStream bridge,
        ...
        if (clazz.isArray()) {
            ...
            result = (java.io.Serializable) bridge
                    .simpleReadObject(clazz, repositoryID, sender, offset);
        }
