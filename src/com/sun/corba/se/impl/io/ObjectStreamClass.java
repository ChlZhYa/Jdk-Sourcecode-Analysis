...
public class ObjectStreamClass implements java.io.Serializable {
    ...
    Object newInstance()
        ...
        if (cons != null) {
            try {
                ...
                InternalError ie = new InternalError(ex);
                throw ie;
            }
        } else {
    ...
    private static long _computeSerialVersionUID(Class<?> cl) {
        ...
        try {
            ...
            SecurityException se = new SecurityException(complain);
            throw se;
        }
    ...
    private static boolean hasStaticInitializer(Class<?> cl) {
        ...
        try {
            ...
            // XXX I18N, logging needed
            InternalError ie = new InternalError("Error invoking hasStaticInitializer", ex);
            throw ie;
        }
    }
