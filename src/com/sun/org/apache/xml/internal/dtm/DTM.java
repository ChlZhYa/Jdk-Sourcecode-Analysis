...
public interface DTM
{
   ...
   *   attribute.
   */
  int getAttributeNode(int elementHandle, String namespaceURI,
          String name);
   ...
   * or DTM.NULL to indicate none exists.
   */
  int getNextNamespaceNode(int baseHandle, int namespaceHandle,
          boolean inScope);
   ...
   */
  char[] getStringValueChunk(int nodeHandle, int chunkIndex,
          int[] startAndLen);
