          ...
          if (thisNode == otherNode)
{
    ...
    public boolean isDefaultNamespace(String namespaceURI){
        ...
        case Node.DOCUMENT_NODE:{
                return ((Document)this).getDocumentElement().isDefaultNamespace(namespaceURI);
            }
    ...
    public String lookupPrefix(String namespaceURI){
        ...
        case Node.DOCUMENT_NODE:{
                return ((Document)this).getDocumentElement().lookupPrefix(namespaceURI);
            }
    ...
    public String lookupNamespaceURI(String specifiedPrefix) {
        ...
        case Node.DOCUMENT_NODE : {
                return ((Document)this).getDocumentElement().lookupNamespaceURI(specifiedPrefix);
            }
        case Node.ENTITY_NODE :
        case Node.NOTATION_NODE:
        case Node.DOCUMENT_FRAGMENT_NODE:
