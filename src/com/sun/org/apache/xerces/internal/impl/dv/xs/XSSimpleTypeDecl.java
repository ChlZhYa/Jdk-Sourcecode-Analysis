...
public class XSSimpleTypeDecl implements XSSimpleType, TypeInfo {
    ...
    private boolean specialCardinalityCheck(){
        return (fBase.fValidationDV == XSSimpleTypeDecl.DV_DATE) || (fBase.fValidationDV
        ...
        if(fVariety == VARIETY_ATOMIC){
            if(fBase.fFinite){
                ...
                if ( ((this.fFacetsDefined & FACET_LENGTH) != 0 ) || ((this.fFacetsDefined & FACET_MAXLENGTH) != 0 )
                    ...
                    this.fFinite = ((this.fFacetsDefined & FACET_FRACTIONDIGITS) != 0)
                            || specialCardinalityCheck();
                }
                else{
                    this.fFinite = false;
            ...
            this.fFinite = ((this.fFacetsDefined & FACET_LENGTH) != 0) || (
                    ((this.fFacetsDefined & FACET_MINLENGTH) != 0)
                            && ((this.fFacetsDefined & FACET_MAXLENGTH) != 0));
    ...
    private boolean isDerivedByList (String ancestorNS, String ancestorName, XSTypeDefinition type) {
        ...
        if (type !=null && ((XSSimpleTypeDefinition)type).getVariety() == VARIETY_LIST) {
            ...
            if (itemType != null) {
                ...
                return isDerivedByRestriction(ancestorNS, ancestorName, itemType);
            }
        }
        return false;
    }
