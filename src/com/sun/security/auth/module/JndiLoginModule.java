...
public class JndiLoginModule implements LoginModule {
        ...
        try {
            ...
            */
            ...
            if (ne.hasMore()) {
                ...
                String encryptedPwd = new String((byte[])pwd.get(), StandardCharsets.UTF_8);
    ...
    private boolean verifyPassword(String encryptedPassword, String password) {
        ...
        Crypt c = new Crypt();
        byte oldCrypt[] = encryptedPassword.getBytes(StandardCharsets.UTF_8);
        byte[] newCrypt = c.crypt(password.getBytes(StandardCharsets.UTF_8),
                                  oldCrypt);
