...
public interface SnmpDefinitions {
     ...
     */
    int snmpReqRefireAfterVbFix = (0xE6) ;
     ...
     */
    int snmpReqUnknownError     = (0xF2) ;

    /**
     * Error code specific to the API.
     * <P>
     */
    int snmpWrongSnmpVersion    = (0xF3) ;
     ...
     * @since 1.5
     */
    int snmpUsmInvalidTimeliness = (0xF8);
     ...
     * @since 1.5
     */
    int snmpV1MsgProcessingModel = snmpVersionOne;
    /**
     * Snmp V2 msg processing model id (1).
     *
     * @since 1.5
     */
    int snmpV2MsgProcessingModel = snmpVersionTwo;
    /**
     * Snmp V3 msg processing model id (3).
     *
     * @since 1.5
     */
    int snmpV3MsgProcessingModel = snmpVersionThree;
     ...
     * @since 1.5
     */
    int snmpV1AccessControlModel = snmpVersionOne;
     ...
     * @since 1.5
     */
    int snmpV2AccessControlModel = snmpVersionTwo;
     ...
     * @since 1.5
     */
    int snmpV3AccessControlModel = snmpVersionThree;
}
