...
public interface SnmpSecuritySubSystem extends SnmpSubSystem {
     ...
     */
     SnmpSecurityCache createSecurityCache(int id) throws SnmpUnknownSecModelException;
    /**
     ...
     */
    void releaseSecurityCache(int id,
     ...
     */
     int generateRequestMsg(SnmpSecurityCache cache,
             int version,
             int msgID,
             int msgMaxSize,
             byte msgFlags,
     ...
     * @return The marshalled byte number.
     */
    int generateResponseMsg(SnmpSecurityCache cache,
            int version,
            int msgID,
            int msgMaxSize,
            byte msgFlags,
     ...
     */
          SnmpSecurityParameters processIncomingResponse(SnmpSecurityCache cache,
                  int version,
                  int msgID,
                  int msgMaxSize,
                  byte msgFlags,
