...
public interface SnmpMsgProcessingModel extends SnmpModel {
     ...
     * @return The pdu.
     */
    SnmpPdu getRequestPdu(SnmpParams p, int type) throws SnmpStatusException;
     ...
     */
     SnmpDecryptedPdu decode(byte[] pdu) throws SnmpStatusException;
     ...
     * @return The encoded bytes number.
     */
    int encode(SnmpDecryptedPdu pdu,
            byte[] outputBytes) throws SnmpTooBigException;
