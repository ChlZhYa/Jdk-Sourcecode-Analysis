...
public interface SnmpMsgProcessingSubSystem extends SnmpSubSystem {
     ...
     */
    void setSecuritySubSystem(SnmpSecuritySubSystem security);
     ...
     */
    SnmpIncomingRequest getIncomingRequest(int model,
     ...
     */
    SnmpOutgoingRequest getOutgoingRequest(int model,
     ...
     * @return The pdu.
     */
    SnmpPdu getRequestPdu(int model, SnmpParams p, int type) throws SnmpUnknownMsgProcModelException, SnmpStatusException ;
     /**
     ...
     */
     SnmpIncomingResponse getIncomingResponse(int model,
             SnmpPduFactory factory) throws SnmpUnknownMsgProcModelException;
    /**
     ...
     */
     SnmpDecryptedPdu decode(int version,
             byte[] pdu)
