...
public interface SnmpSubSystem {
     ...
     */
    void addModel(int id, SnmpModel model);
     ...
     */
    SnmpModel removeModel(int id) throws SnmpUnknownModelException;
     ...
     * @return The model.
     */
    SnmpModel getModel(int id) throws SnmpUnknownModelException;
