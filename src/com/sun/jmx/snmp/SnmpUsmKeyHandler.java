...
public interface SnmpUsmKeyHandler {
     ...
     * @exception IllegalArgumentException If the algorithm is unknown.
     */
    byte[] localizeAuthKey(String algoName, byte[] key, SnmpEngineId engineId) throws IllegalArgumentException;
     ...
     * @exception IllegalArgumentException If the algorithm is unknown.
     */
    byte[] localizePrivKey(String algoName, byte[] key, SnmpEngineId engineId, int keysize) throws IllegalArgumentException;
     ...
     * @exception IllegalArgumentException If the algorithm is unknown.
     */
    byte[] calculateAuthDelta(String algoName, byte[] oldKey, byte[] newKey, byte[] random) throws IllegalArgumentException;
     ...
     * @exception IllegalArgumentException If the algorithm is unknown.
     */
    byte[] calculatePrivDelta(String algoName, byte[] oldKey, byte[] newKey, byte[] random,
